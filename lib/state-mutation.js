...
var updateOrInsertResource = exports.updateOrInsertResource = function updateOrInsertResource(state, resource) {
  ...
  if (stateContainsResource(state, resource)) {
    ...
    var newResource = (0, _merge2.default)({}, resources[idx], resource);

    if (!(0, _deepEqual2.default)(resources[idx], newResource)) {
      newState = _objectPathImmutable2.default.set(newState, updatePath.concat(idx), newResource);
    }
  } else {
