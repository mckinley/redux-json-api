...
describe('Relationships without data key should not be reset', () => {
  it('should append read resources to state', () => {
    ...
    expect(updatedState.articles.data[0].attributes.title).toEqual('JSON API paints my bikeshed!');
    ...
    expect(updatedState2.articles.data[0].attributes.title).toEqual('JSON API paints my bikeshed!');
